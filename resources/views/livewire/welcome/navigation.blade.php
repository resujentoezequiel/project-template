...
{{--        <div style="background-color: darkgoldenrod; border-color: #1e2127; border-width: .2rem; padding: .5rem .5rem; border-radius: 2rem 2rem 2rem 2rem; width: 10rem; text-align: center">--}}
{{--            <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" wire:navigate>--}}
{{--                <span>LOG-IN</span>--}}
{{--            </a>--}}
{{--        </div>--}}
